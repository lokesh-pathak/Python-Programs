...
# alphabet assigns code words to the letters of the English alphabet acrophonically 
# (Alfa for A, Bravo for B, etc.) 
# so that critical combinations of letters (and numbers) 
# can be pronounced and understood by those who transmit and 
